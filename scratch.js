(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`/assets/kerobot-ss1-BSwLXgN4.png`,t=`/assets/kerobot-ss2-CTXtv8q0.png`,n=`/assets/kerobot-ss3-XahfYZEo.png`,r=`/assets/kerobot-ss4-D_kImGNz.png`,i=`/assets/pirates-ss1-w6ldpPnq.png`,a=`/assets/pirates-ss2-B9s0IS2z.png`,o=`/assets/pirates-ss3-nfA-x1FK.png`,s=`/assets/pirates-ss4-Cg-FXlhf.png`,c=`/assets/firehits-ss1-_u-v4my9.png`,l=`/assets/firehits-ss2-BRK5rc-r.jpg`,u=`/assets/firehits-ss3-BMQj3TB8.png`,d=`/assets/firehits-ss4-CHkPo0hF.png`,f=`/assets/polyrace-ss1-CKj_Q8YS.png`,p=`/assets/polyrace-ss2-yUfG1hhs.png`,m=`/assets/polyrace-ss3-BImoG-Sa.png`,h=`/assets/polyrace-ss4-CRWVOfAO.png`,g=`/assets/polyrace-ss5-KPo-7yNh.png`,_={name:`INDRAJ`,title:`Game Developer`,tagline:`Building interactive worlds, gameplay experiences, and engaging games with Unity, Unreal Engine, and Godot.`,aboutShort:`I am a passionate game developer dedicated to crafting immersive interactive experiences and fluid gameplay mechanics. With a strong foundation in core game logic, system architecture, and performance optimization, I bring creative concepts to life across multiple game engines.`,aboutDetailed:`My journey in game development is driven by a deep fascination with how mechanics, physics, and storytelling intersect to create memorable player experiences. I specialize in designing responsive player controls, optimizing real-time systems, and building scalable codebases for both 2D and 3D games. Whether tweaking physics parameters or refining core gameplay loops, I focus on building engaging, polished games that keep players coming back.`,education:`B.Tech in Computer Science & Engineering | MITK`,experience:`2 years of hands-on experience designing and programming 2D and 3D games, focusing on mechanics implementation, UI integration, and engine performance optimization.`,avatar:null},v=[{name:`Unity`,icon:`unity`,description:`Game development, gameplay programming, and interactive experiences for 2D and 3D games.`,color:`#1A1A2E`},{name:`Unreal Engine`,icon:`unreal`,description:`Real-time 3D development and immersive game environments with powerful visual tools.`,color:`#1A1A2E`},{name:`Godot`,icon:`godot`,description:`Lightweight game development and rapid prototyping for 2D and 3D projects.`,color:`#478CBF`}],y=[{id:1,name:`Kero Bot`,shortDescription:`A 2D pixel-art platformer where you guide a frog robot through challenging levels filled with enemies, collectibles, and obstacles.`,fullDescription:`Kero Bot is a classic-style 2D platformer built in Godot Engine. Players control a small frog robot navigating through multiple themed levels — from grassy outdoor areas to underground caves and twilight skies. The game features touch-based controls with directional buttons and a jump mechanic, collectible cherries for scoring, enemy mushrooms to avoid, and a health system with heart-based lives. Each level introduces new challenges with increasing difficulty, obstacles like moving platforms and destructible blocks, and a trophy at the end to mark completion.`,genre:`Platformer`,platform:`Android`,engine:`Godot`,type:`2D`,duration:`1 month`,role:`Solo Developer`,contribution:`Designed and implemented the entire game from scratch — player controls, level design, enemy AI, UI system, pause menu, scoring system, and multi-level progression.`,features:[`Touch-based directional controls & jump button`,`Multi-level progression with unique themed environments`,`Points system with cherry collectibles`,`Health system with heart-based lives`,`Enemy mushroom AI with patrol behavior`,`Pause menu with resume & main menu options`],challenges:[{problem:`Making responsive touch controls that feel precise on mobile devices`,solution:`Implemented custom touch input zones with adjustable dead zones and immediate response to directional and jump inputs`},{problem:`Designing levels that are challenging but fair for mobile players`,solution:`Iteratively playtested each level, adjusting platform spacing, enemy placement, and collectible positioning for a balanced difficulty curve`}],screenshots:[e,t,n,r],coverImage:e,videoUrl:null,apkUrl:`https://drive.google.com/file/d/1qFtuQtF_5eAo4hMFDfJ0TDKURvSa-ZuV/view?usp=drive_link`,githubUrl:null},{id:2,name:`Pirates Maker`,shortDescription:`A 2D pirate-themed platformer built with Python & Pygame, featuring sword combat, 6 handcrafted levels, and a world map navigation system.`,fullDescription:`Pirates Maker is a pixel-art 2D platformer developed entirely in Python using the Pygame library. Players take on the role of a swashbuckling pirate navigating through 6 distinct island levels connected by a world map. The game features sword-based combat against enemy robots, palm-tree-filled tropical environments, platforming challenges across floating stone islands, and a timer-based scoring system. Each level ends with an "end" marker, and the game tracks completion time with a Game Over screen showing stats and replay options.`,genre:`Platformer`,platform:`Android`,engine:`Python / Pygame`,type:`2D`,duration:`1 month`,role:`Solo Developer`,contribution:`Built the entire game from scratch in Python — game engine loop, physics, sprite animations, level loading, world map system, combat mechanics, UI, and timer system.`,features:[`Sword-based combat with enemy AI`,`6 handcrafted levels with unique layouts`,`World map navigation with level connections`,`Timer-based scoring & Game Over stats`,`Touch & keyboard controls with jump mechanics`,`Pixel-art pirate theme with tropical environments`],challenges:[{problem:`Building a full game engine from scratch without a dedicated game framework`,solution:`Implemented custom game loop, collision detection, sprite management, and scene transitions using only Pygame primitives`},{problem:`Creating a connected world map with level progression tracking`,solution:`Designed a node-based map system where completed levels unlock paths to the next, with visual indicators for each level state`}],screenshots:[i,a,o,s],coverImage:i,videoUrl:null,apkUrl:`https://drive.google.com/file/d/1c6bwH6aeqpUkRxiSY-4mjy7xd93Vvrw4/view?usp=drive_link`,githubUrl:null},{id:3,name:`Fire-Hits`,shortDescription:`A thrilling 2D action-defense adventure built in Unity where you protect Queen Isolde by slaying waves of undead skeletons.`,fullDescription:`Fire-Hits is a 2D action-defense game built in Unity Engine for Android. Players take on the role of a warrior tasked with protecting Queen Isolde from waves of attacking skeleton enemies in a dark, atmospheric forest setting. The game features real-time combat with a sword attack system, directional movement controls, a kill counter to track your score, and a survival timer. The dark pixel-art environment creates an intense atmosphere as skeletons close in from both sides. Includes a full menu system with pause, resume, main menu, and retry options.`,genre:`Action-Defense`,platform:`Android`,engine:`Unity`,type:`2D`,duration:`1 month`,role:`Solo Developer`,contribution:`Designed and developed the complete game in Unity using C# — enemy wave spawning system, combat mechanics, UI/HUD, pause system, game over logic, and atmospheric pixel-art integration.`,features:[`Real-time sword combat against skeleton waves`,`Kill counter & survival timer HUD`,`Directional movement with attack button`,`Dark atmospheric pixel-art forest environment`,`Full menu system — pause, resume, main menu, quit`,`Game Over screen with retry option`],challenges:[{problem:`Managing multiple enemy waves spawning from both sides simultaneously`,solution:`Implemented an object pooling system with directional spawn points and wave difficulty scaling based on survival time`},{problem:`Creating responsive touch combat that feels satisfying on mobile`,solution:`Fine-tuned attack hitbox timing, added hit feedback animations, and optimized input detection for simultaneous move + attack actions`}],screenshots:[c,l,u,d],coverImage:l,videoUrl:null,apkUrl:`https://drive.google.com/file/d/105Anq3jXxY9nDemarrSyb6CFoXJkK6qv/view?usp=drive_link`,githubUrl:null},{id:4,name:`PolyRace`,shortDescription:`A high-speed 3D low-poly racing game built in Unity featuring hovercraft vehicles, desert tracks, and time attack modes. Currently in development.`,fullDescription:`PolyRace is a 3D racing game built in Unity with a stunning low-poly art style. Players pilot futuristic hovercrafts at extreme speeds (600+ km/h) through procedurally styled desert canyon tracks. The game features a full HUD with speedometer, distance tracker, and precision lap timer. It includes a training mode with hovercraft selection, level selection (Desert/Extreme), and race type options (Time Attack). A comprehensive settings menu covers audio/video/localization with resolution, quality, fullscreen, and volume controls. Currently in active development with more tracks, vehicles, and multiplayer planned.`,genre:`Racing`,platform:`PC`,engine:`Unity`,type:`3D`,duration:`In Development`,role:`Solo Developer`,contribution:`Building the entire game — vehicle physics, track design, HUD system, menu/settings UI, audio system, and low-poly environment art pipeline.`,features:[`High-speed hovercraft racing at 600+ km/h`,`Low-poly desert canyon environments`,`Precision speedometer & lap timer HUD`,`Training mode with vehicle & track selection`,`Full settings system — audio, video, resolution, localization`,`Time Attack race mode`],challenges:[{problem:`Achieving smooth high-speed movement without physics jitter at 600+ km/h`,solution:`Implemented custom hovercraft physics with fixed-timestep updates, interpolation, and camera smoothing to maintain fluid visuals at extreme speeds`},{problem:`Creating visually appealing low-poly environments that feel expansive`,solution:`Designed modular canyon pieces with vertex-colored meshes, atmospheric fog, and dynamic lighting to create depth in the desert landscape`}],screenshots:[f,p,m,h,g],coverImage:g,videoUrl:null,apkUrl:null,githubUrl:null}],b={gameDev:[`Gameplay Development`,`Game Mechanics`,`Game UI`,`Level Design`,`Game Testing`],engines:[`Unity`,`Unreal Engine`,`Godot`],programming:[`Python`,`C#`,`C++`,`GDScript`],other:[`Git & Version Control`,`Blender`,`Game Physics`,`Performance Optimization`,`UI/UX Design`]},x=[{date:`2024`,title:`Started Game Development & Godot`,description:`Took my first steps into game programming using Godot, learning the core fundamentals of game logic, scene trees, and node-based architectures.`},{date:`2024 – 2025`,title:`Built First Game`,description:`Designed and programmed my initial complete game project, focusing on player controls, core loops, and UI integration.`},{date:`2025`,title:`Learned Unity`,description:`Expanded into Unity to master C# scripting, 3D asset workflows, component systems, and performance optimization techniques.`},{date:`2025`,title:`Learned Unreal Engine`,description:`Dived into Unreal Engine to work with advanced rendering features, materials, physics systems, and Blueprint/C++ integration.`},{date:`2025 – 2026`,title:`Built Additional Games`,description:`Developed and released 4 to 5 complete titles across different genres, refining game mechanics, level design, and system architecture.`},{date:`Present`,title:`Building High-Graphics 3D Racing Game`,description:`Currently building a high-fidelity 3D racing game featuring realistic vehicle physics, dynamic lighting, and optimized real-time rendering.`}],S={heading:`Let's Build Something Great`,tagline:`Interested in my work or want to collaborate? Feel free to reach out.`,linkedin:`https://www.linkedin.com/in/indraj-a-g-6701b4342`,github:`https://github.com/Indraj-2005`,email:`indrajag2005@gmail.com`,resume:`/resume.html`},C=[{stage:`Idea`,icon:`lightbulb`,description:`Concept & vision`},{stage:`Design`,icon:`design`,description:`Game design & planning`},{stage:`Develop`,icon:`code`,description:`Building & coding`},{stage:`Test`,icon:`test`,description:`Testing & debugging`},{stage:`Launch`,icon:`launch`,description:`Finished game`}],w={unity:`/assets/unity-logo-DnujvbjE.png`,unreal:`/assets/unreal-logo-CzeZo5LF.png`,godot:`/assets/godot-logo-BtN9lhal.png`},T={unity:`<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
    <path d="M44.4 32L55.2 13.3L48.8 2.7L37.6 16H26.4L15.2 2.7L8.8 13.3L19.6 32L8.8 50.7L15.2 61.3L26.4 48H37.6L48.8 61.3L55.2 50.7L44.4 32Z" fill="currentColor"/>
    <path d="M37.6 16L48.8 2.7L58.4 8L47.6 24H37.6V16Z" fill="currentColor" opacity="0.6"/>
    <path d="M47.6 24V40L58.4 56L48.8 61.3L37.6 48V40H47.6Z" fill="currentColor" opacity="0.4"/>
    <path d="M26.4 16L15.2 2.7L5.6 8L16.4 24H26.4V16Z" fill="currentColor" opacity="0.4"/>
    <path d="M16.4 40V24L5.6 8L5.6 56L15.2 61.3L26.4 48V40H16.4Z" fill="currentColor" opacity="0.6"/>
    <path d="M26.4 24H37.6L44.4 32L37.6 40H26.4L19.6 32L26.4 24Z" fill="currentColor" opacity="0.15"/>
  </svg>`,unreal:`<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
    <path d="M32 4C16.536 4 4 16.536 4 32s12.536 28 28 28 28-12.536 28-28S47.464 4 32 4zm0 4.8c12.812 0 23.2 10.388 23.2 23.2S44.812 55.2 32 55.2 8.8 44.812 8.8 32 19.188 8.8 32 8.8z" fill="currentColor"/>
    <path d="M22 20c-2.5 2.5-3.5 6-3.5 10v8.5c0 0 1.5 2 3 3l2.5-2.5V24.5c0-1.5.5-3 2-4.5 0 0-1.5-.5-4 0z" fill="currentColor"/>
    <path d="M24 39l-2.5 2.5c2 1.8 4.5 3 6.5 3.5 3 .8 6.5.5 9.5-1.5 2.5-1.7 4.5-4 5.5-7l-3 2c-1.5 2-3.5 3.5-5.5 4-3 1-6 .5-8-1L24 39z" fill="currentColor"/>
    <path d="M31 21c-1 1-1.5 2.5-1.5 4v12l-3 3 2 2c1-.5 2.5-2 3.5-3.5V25c0-1 .5-2 1.5-3l4.5 3v12.5l3-2V24l-2.5-4.5L31 21z" fill="currentColor"/>
  </svg>`,godot:`<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
    <path d="M32 8c-1.5 0-2.7.3-2.7.3L27 6l-2.3 2.5-3-.5-1.2 3-3.2.8-.2 3.2-2.8 1.6 1 3-2.2 2.4 2 2.5-1.2 2.8 2.6 1.8v11.2c0 2.8 2.2 5 5 5h1.6l1-4h14.4l1 4H41c2.8 0 5-2.2 5-5V33.4l2.6-1.8-1.2-2.8 2-2.5-2.2-2.4 1-3-2.8-1.6-.2-3.2-3.2-.8-1.2-3-3 .5L35 6l-2.3 2.3S33.5 8 32 8z" fill="currentColor"/>
    <ellipse cx="24" cy="26" rx="4.5" ry="5" fill="white"/>
    <ellipse cx="40" cy="26" rx="4.5" ry="5" fill="white"/>
    <circle cx="24" cy="26.5" r="2.5" fill="#333"/>
    <circle cx="40" cy="26.5" r="2.5" fill="#333"/>
    <rect x="29" y="29" width="6" height="2" rx="1" fill="white"/>
    <path d="M23 37h18v3c0 0-1 2-9 2s-9-2-9-2v-3z" fill="white"/>
    <line x1="27" y1="37" x2="27" y2="42" stroke="currentColor" stroke-width="1"/>
    <line x1="32" y1="37" x2="32" y2="42" stroke="currentColor" stroke-width="1"/>
    <line x1="37" y1="37" x2="37" y2="42" stroke="currentColor" stroke-width="1"/>
  </svg>`,arrowRight:`<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M6 3L11 8L6 13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>`,arrowLeft:`<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 3L5 8L10 13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>`,download:`<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,linkedin:`<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
  </svg>`,email:`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,resume:`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,gamepad:`<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M38 16H10C7.79 16 6 17.79 6 20V32C6 34.21 7.79 36 10 36H38C40.21 36 42 34.21 42 32V20C42 17.79 40.21 16 38 16Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
    <circle cx="17" cy="26" r="3" stroke="currentColor" stroke-width="2"/>
  ...
  </svg>`,play:`<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="24" cy="24" r="20" stroke="currentColor" stroke-width="2"/>
    <path d="M20 16L34 24L20 32V16Z" fill="currentColor"/>
  </svg>`,star:`⭐`,gear:`⚙️`,puzzle:`🧩`,target:`🎯`,sparkle:`✨`,controller:`🎮`,palette:`🎨`,sound:`🔊`};function E(e){let t=e.toLowerCase();return t.includes(`unity`)?`<img src="${w.unity}" alt="Unity" style="width:36px;height:36px;object-fit:contain;" />`:t.includes(`unreal`)?`<img src="${w.unreal}" alt="Unreal Engine" style="width:36px;height:36px;object-fit:contain;" />`:t.includes(`godot`)?`<img src="${w.godot}" alt="Godot" style="width:36px;height:36px;object-fit:contain;" />`:T.gamepad}var D=[`🎮`,`🕹️`,`👾`,`🏗️`,`🎨`,`📊`,`🔊`,`⚡`,`🎯`,`🧩`],O=`/assets/indraj-photo-Dtce09QH.jpg`;function k(){let e=document.getElementById(`app`);e.innerHTML=`
    ${A()}
    ${ee()}
    ${te()}
    ${j()}
  ...
  `}function A(){return`
    <nav class="navbar" id="navbar">
      <div class="navbar__inner">
        <a href="#hero" class="navbar__logo">INDRAJ'S <span>PORTFOLIO</span></a>
        <div class="navbar__links">
          <a href="#about" class="navbar__link">About</a>
          <a href="#engines" class="navbar__link">Engines</a>
          <a href="#games" class="navbar__link">Games</a>
          <a href="#pipeline" class="navbar__link">Process</a>
    ...
    <section class="hero section" id="hero">
      ...
      <div class="container hero__inner">
        <div class="hero__content">
          ...
          <h1 class="hero__name">${_.name}</h1>
          <p class="hero__title">${_.title}</p>
          <p class="hero__tagline">"${_.tagline}"</p>
          <div class="hero__buttons">
            <a href="#games" class="btn btn--primary btn--large">
              Explore My Games ${T.arrowRight}
            </a>
        ...
        <div class="hero__photo-card">
          ...
          <img src="${O}" alt="INDRAJ" class="hero__photo-img" />
        </div>
      </div>
    </section>
  `}function te(){return`
    <section class="section section--alt" id="about">
      <div class="container about__inner">
        <div class="about__text reveal">
          <span class="section__label">Introduction</span>
          ...
          <div class="about__info">
            <div class="about__info-item">
              <div class="about__info-label">Education</div>
              <div class="about__info-value">${_.education}</div>
            </div>
            <div class="about__info-item">
              <div class="about__info-label">Experience</div>
              <div class="about__info-value">${_.experience}</div>
            </div>
          </div>
          <div class="about__engines">
            ${v.map(e=>`
              <span class="about__engine-tag">
                ${e.name}
              </span>
            `).join(``)}
          </div>
        </div>
        <div class="about__3d reveal reveal--delay-2" id="about-canvas"></div>
      </div>
    </section>
  `}function j(){return`
    <section class="section" id="engines">
      <div class="container">
        <div class="reveal" style="text-align: center;">
          <span class="section__label">Technologies</span>
          <h2 class="section__title" style="margin-left: auto; margin-right: auto;">Game Engines I Work With</h2>
          <p class="section__subtitle" style="margin-left: auto; margin-right: auto;">Building games across multiple engines for diverse platforms and experiences.</p>
        </div>
        <div class="engines__grid">
          ${v.map((e,t)=>`
            <div class="engine-card tilt-card reveal reveal--delay-${t+1}">
              <div class="engine-card__icon">
                ${E(e.name)}
              </div>
              <h3 class="engine-card__name">${e.name}</h3>
    ...
    <section class="section section--alt" id="games">
      <div class="container">
        <div class="reveal" style="text-align: center;">
          ...
          <h2 class="section__title" style="margin-left: auto; margin-right: auto;">My Games</h2>
          <p class="section__subtitle" style="margin-left: auto; margin-right: auto;">A collection of 2D and 3D games I've built, available as Android APKs.</p>
        </div>
        <div class="games__grid">
          ${y.map((e,t)=>`
            <a href="#/game/${e.id}" class="game-card tilt-card reveal reveal--delay-${t%4+1}">
              <div class="game-card__cover">
                ${e.coverImage?`<img src="${e.coverImage}" alt="${e.name}" />`:`<div class="game-card__cover-placeholder">
                      ${T.gamepad}
                      <span style="font-size: 0.75rem; font-weight: 600;">${e.name}</span>
                    </div>`}
              </div>
              <div class="game-card__body">
                <div class="game-card__meta">
                  <span class="game-card__tag">${e.genre}</span>
                  <span class="game-card__tag">${e.type}</span>
                  <span class="game-card__tag">${e.platform}</span>
                  <span class="game-card__tag game-card__tag--engine">${e.engine}</span>
                </div>
                <h3 class="game-card__name">${e.name}</h3>
                <p class="game-card__desc">${e.shortDescription}</p>
                <div class="game-card__footer">
                  <span class="game-card__view">
                    View Project ${T.arrowRight}
                  </span>
                </div>
              </div>
            </a>
  ...
  `}function re(){let e=[`💡`,`📐`,`💻`,`🎮`,`🚀`];return`
    <section class="section" id="pipeline">
      <div class="container">
        <div class="reveal" style="text-align: center;">
          <span class="section__label">Process</span>
          <h2 class="section__title" style="margin-left: auto; margin-right: auto;">From Idea → Game</h2>
          <p class="section__subtitle" style="margin-left: auto; margin-right: auto;">My game development pipeline from concept to finished product.</p>
        </div>
        <div class="pipeline__track reveal">
          ${C.map((t,n)=>`
            <div class="pipeline__step">
              <div class="pipeline__icon">${e[n]}</div>
              <div>
                <div class="pipeline__step-name">${t.stage}</div>
                <div class="pipeline__step-desc">${t.description}</div>
              </div>
            </div>
          `).join(``)}
        </div>
        <div class="pipeline__3d reveal" id="pipeline-canvas"></div>
      </div>
    </section>
  `}function M(){return`
    <section class="section section--alt" id="skills">
      <div class="container">
        <div class="reveal" style="text-align: center;">
          ...
          <h2 class="section__title" style="margin-left: auto; margin-right: auto;">Skills</h2>
        </div>
        <div class="skills__grid">
          <div class="skills__category reveal reveal--delay-1">
          ...
          <div class="skills__category reveal reveal--delay-2">
            <h3>Engines</h3>
            <div class="skills__list">
              ${b.engines.map(e=>`
                <div class="skill-item">
          ...
          <div class="skills__category reveal reveal--delay-3">
            <h3>Programming</h3>
            <div class="skills__list">
              ${b.programming.map(e=>`
                <div class="skill-item">
          ...
          <div class="skills__category reveal reveal--delay-4">
            <h3>Other Skills</h3>
            <div class="skills__list">
              ${b.other.map(e=>`
                <div class="skill-item">
  ...
  `}function ie(){return`
    <section class="section" id="journey">
      <div class="container">
        <div class="reveal">
          <span class="section__label">Timeline</span>
          <h2 class="section__title">My Game Development Journey</h2>
        </div>
        <div class="timeline">
          ${x.map((e,t)=>`
            <div class="timeline__item reveal reveal--delay-${t%4+1}">
    ...
    <section class="section section--alt" id="contact">
      <div class="container">
        <div class="contact__inner reveal">
          ...
          <h2 class="section__title">${S.heading}</h2>
          <p class="section__subtitle" style="margin-left: auto; margin-right: auto;">${S.tagline}</p>
          <div class="contact__buttons">
            <a href="${S.linkedin}" target="_blank" rel="noopener" class="btn btn--secondary">
              ${T.linkedin} LinkedIn
            </a>
            <a href="${S.github}" target="_blank" rel="noopener" class="btn btn--secondary">
              ${T.github} GitHub
            </a>
            <a href="mailto:${S.email}" class="btn btn--secondary">
              ${T.email} Email
            </a>
            <a href="${S.resume}" target="_blank" rel="noopener" class="btn btn--primary">
              ${T.resume} Resume
            </a>
          </div>
        </div>
  ...
  `}function oe(){return`
    <footer class="footer">
      <div class="container">
        <p class="footer__text">© ${new Date().getFullYear()} ${_.name}. Built with passion for games.</p>
      </div>
    </footer>
  `}function se(e){let t=document.getElementById(`app`),n=y.find(t=>t.id===e);if(!n){t.innerHTML=he();return}t.innerHTML=`
    ${N()}
  ...
  `}function N(){return`
    <nav class="navbar navbar--scrolled" id="navbar">
      <div class="navbar__inner">
        <a href="#/" class="navbar__logo">${_.name.split(` `)[0]}<span>.</span></a>
        <div class="navbar__links">
          <a href="#/" class="navbar__link">← Back to Home</a>
        </div>
      </div>
    </nav>
  `}function ce(){return`
    <a href="#/" class="game-detail__back reveal">
      ${T.arrowLeft} Back to All Games
    </a>
  `}function P(e){return`
    <div class="game-detail__header reveal">
      <div class="game-detail__cover">
        ${e.coverImage?`<img src="${e.coverImage}" alt="${e.name}" />`:`<div class="game-card__cover-placeholder">
              ${T.gamepad}
              <span style="font-size: 1rem; font-weight: 600; color: var(--text-tertiary);">${e.name}</span>
            </div>`}
      </div>
      <div class="game-detail__info">
        ...
        <div class="game-detail__actions">
          ${e.apkUrl&&!e.apkUrl.startsWith(`[`)?`<a href="${e.apkUrl}" target="_blank" rel="noopener" class="btn btn--primary">
                ${T.download} Download APK
              </a>`:`<span class="btn btn--primary" style="opacity: 0.5; cursor: not-allowed;">
                ${T.download} APK Coming Soon
              </span>`}
          ${e.githubUrl?`<a href="${e.githubUrl}" target="_blank" rel="noopener" class="btn btn--secondary">
                ${T.github} View Source
              </a>`:``}
        </div>
      </div>
    </div>
  `}function F(e,t){return`
    <div class="game-detail__meta-item">
      <div class="game-detail__meta-label">${e}</div>
      <div class="game-detail__meta-value">${t||`—`}</div>
    </div>
  `}function le(e){return e.fullDescription?`
    <div class="game-detail__section reveal">
      <h2>About This Game</h2>
      <p class="game-detail__description">${e.fullDescription}</p>
      ${e.contribution&&!e.contribution.startsWith(`[`)?`<p class="game-detail__description" style="margin-top: var(--space-lg);">
            <strong>My Contribution:</strong> ${e.contribution}
          </p>`:``}
    </div>
  `:``}function ue(e){return!e.features||!e.features.length?``:`
    <div class="game-detail__section reveal">
      <h2>Key Features</h2>
      <div class="features__grid">
        ${e.features.map((e,t)=>`
          <div class="feature-card">
            <div class="feature-card__icon">${D[t%D.length]}</div>
            <div class="feature-card__text">${e}</div>
          </div>
        `).join(``)}
      </div>
    </div>
  `}function de(e){return!e.challenges||!e.challenges.length?``:`
    <div class="game-detail__section reveal">
      <h2>Challenges & Solutions</h2>
      <div class="challenges__list">
        ${e.challenges.map(e=>`
          <div class="challenge-item">
            <div class="challenge-item__problem">
              <div class="challenge-item__label">Challenge</div>
              <div class="challenge-item__text">${e.problem}</div>
            </div>
            <div class="challenge-item__solution">
              <div class="challenge-item__label">Solution</div>
              <div class="challenge-item__text">${e.solution}</div>
            </div>
          </div>
        `).join(``)}
      </div>
    </div>
  `}function fe(e){return!e.screenshots||!e.screenshots.length?``:`
    <div class="game-detail__section reveal">
      <h2>Screenshots</h2>
      <div class="screenshots__grid">
        ${e.screenshots.map((t,n)=>`
          <div class="screenshot-item">
            <img src="${t}" alt="${e.name} screenshot ${n+1}" />
          </div>
        `).join(``)}
      </div>
    </div>
  `}function pe(e){return e.videoUrl?`
    <div class="game-detail__section reveal">
      <h2>Gameplay Video</h2>
      <div class="video__container">
        <iframe
          src="${e.videoUrl}"
          title="${e.name} gameplay"
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Go(e,t,n){let r=new Float32Array(jo),i=new K(0,1,0);return new _a({name:`SphericalGaussianBlur`,defines:{n:jo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Jo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ko(){return new _a({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Jo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qo(){return new _a({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Jo(),fragmentShader:`
	...
	`}var Yo=class extends kn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Qi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
